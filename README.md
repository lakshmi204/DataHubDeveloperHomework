...
```
This project builds a simple Spark-based data pipeline to ingest, clean, and analyze ACME grocery store transaction data. 
The pipeline reads raw CSV files, prepares the data, joins dimension tables, and generates analytics insights.
```
